...
var enemyCurve_scene = preload("res://Enemies/EnemyCurve.tscn")
...
func spawn_enemy():
	var enemyCurve = enemyCurve_scene.instance()
	enemyCurve.global_position = rand_pos()
	get_parent().add_child(enemyCurve)
