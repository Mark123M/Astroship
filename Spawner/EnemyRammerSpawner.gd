...
var enemyRammer_scene = preload("res://Enemies/EnemyRammer.tscn")
...
func spawn_enemy():
	var enemyRammer = enemyRammer_scene.instance()
	enemyRammer.global_position = rand_pos()
	get_parent().add_child(enemyRammer)
