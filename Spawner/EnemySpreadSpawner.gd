...
var enemySpread_scene = preload("res://Enemies/EnemySpread.tscn")
...
func spawn_enemy():
	var enemySpread = enemySpread_scene.instance()
	enemySpread.global_position = rand_pos()
	get_parent().add_child(enemySpread)
	#print(enemySpread.global_position)
